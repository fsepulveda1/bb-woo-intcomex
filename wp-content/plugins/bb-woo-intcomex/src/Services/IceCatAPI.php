...
class IceCatAPI
{
    ...
    public function __construct()
    {
        ...
        $this->username = $options['field_icecat_username'] ?? "";
        $this->password = $options['field_icecat_password'] ?? "";
        $this->init();
    }
    /**
     ...
     * @return bool|\SimpleXMLElement
     */
    public function getArticleByEAN($ean, $lang='ES')
    {
        $params = array(
            'ean_upc' => $ean,
            'lang' => $lang
     ...
     * @return bool|\SimpleXMLElement
     */
    public function getArticleByMPN($vendor, $mpn, $lang='ES')
    {
        $params = array(
            'prod_id' => trim($mpn),
            'vendor' => trim($vendor),
     ...
     * @return bool|\SimpleXMLElement
     */
    public function getArticleById($icecatId, $lang='ES') {
